...
AEnemigoGargola::AEnemigoGargola()
{
    ...
    static ConstructorHelpers::FObjectFinder<UAnimSequence> AnimationAsset(TEXT("AnimSequence'/Game/QuadrapedCreatures/Griffon/Animations/ANIM_Griffon_FlyStationary.ANIM_Griffon_FlyStationary'"));
